<template>
  <div>
    <div v-if="$store.state.locales.locale === 'en'">
      <h1 class="font-bold text-3xl py-4">Terms of Use</h1>
      <pre class="font-sans">
2019.6.1
...
(a) email address: cs@empoapp.com
...
(2) The Company defines the specifics of the matters related to the collection, use, provision, protection, and entrustment of personal information through the Privacy Policy which is posted on the Company's web page and the App service screen.
...
[https://support.google.com/googleplay/answer/2479637?hl=ko](https://support.google.com/googleplay/answer/2479637?hl=ko)
...
The Terms is effective from July 1, 2019.
    ...
    <div v-if="$store.state.locales.locale === 'ko'">
      <h1 class="font-bold text-3xl py-4">서비스 이용 약관</h1>
...
(o) "데이터"라 함은 회원이 회사가 제공하는 서비스를 이용할 때 현금처럼 사용할 수 있는 회사 전용의 전자금융거래법상 선불전자지급수단을 말합니다.

(p) “충전”이란 회원이 서비스를 이용하기 위하여 회사가 회원이 결제수단으로 등록한 신용카드 등에서 회원이 요청한 금액을 출금하고, 해당 금액만큼 회원의 데이터를 늘리는 등의 방법으로 회원의 데이터 보유 잔량을 증가시키는 행위를 말합니다.

(q) "환급(이하 “리워드"라 함)"이란 회사가 회원의 요청에 따라 회원의 앰퍼 데이터 잔량 범위 내에서 회원이 요청하는 금액을 회원이 지정한 금융기관의 계좌로 입금하는 것을 말합니다.

(r) "수수료"란 회원이 회사의 서비스를 이용하는 과정에서 회사가 정하는 기준에 따라 회원에게 부과하는 비용을 말합니다.

(2) 본 조 및 본 약관의 다른 조항에서 정의한 것을 제외하고는 전자상거래에서의 소비자보호 등에 관한 법률, 전자금융거래법 등 관련 법령에 정한 바에 따릅니다.

제 3 조 (약관의 명시·교부·설명 및 변경)

(1) 회사는 회원이 전자금융거래 서비스를 이용하기 전에 이 약관을 게시하고, 회원이 이 약관의 중요한 내용을 확인할 수 있도록 합니다.
...
(a) 약관의 중요내용을 회원에게 직접 설명

(b) 약관의 중요내용에 대한 설명을 전자적 장치를 통하여 회원이 알기 쉽게 표시하고 회원으로부터 해당 내용을 충분히 인지하였다는 의사표시를 전자적 장치를 통하여 수령

(4) 회사가 약관을 변경하고자 하는 경우에는 변경 1월 전에 변경되는 약관을 해당 서비스를 수행하는 전자적 장치 또는 회사의 웹사이트에 게시하고 회원에게 이메일 또는 문자메시지 발송 등의 방식으로 통지합니다. 다만, 본문에도 불구하고 법령의 개정으로 인하여 긴급하게 약관을 변경한 때에는 변경된 약관을 전자적 장치에 최소 1월 이상 게시하고 회원에게 통지합니다.

(5) 회사는 제4항의 게시나 통지를 할 경우 "회원이 변경에 동의하지 아니한 경우 약관의 변경 내용이 게시되거나 통지를 받은 날로부터 30일 이내에 계약을 해지할 수 있으며, 계약해지의 의사표시를 하지 아니한 경우에는 변경에 동의한 것으로 본다."라는 취지의 내용을 게시하거나 통지합니다.

(6) 회원은 약관의 변경내용이 게시되거나 통지된 후부터 변경되는 약관의 시행일 전의 영업일까지 회사와 전자금융거래의 계약을 해지할 수 있습니다. 이 기간 안에 회원이 약관의 변경내용에 대하여 이의를 제기하지 아니하는 경우에는 약관의 변경을 승인한 것으로 봅니다.

제 4 조 (이용계약의 체결)

(1) 서비스 이용계약은, 회원이 되고자 하는 자(이하 "가입신청자")가 회사에서 요구하는 정보를 제공하고, 회사가 지정하는 방법에 따라 이 약관에 대한 동의 의사를 전자적 방식으로 제출한 후, 회사가 다음 각호의 요건을 확인하여 해당 가입신청자에게 이용을 승낙함으로써 체결됩니다.

(a) 가입신청자는 본인 명의로 통신사에 가입된 휴대전화 또는 태블릿 등 앰포 앱을 구동할 수 있는 전자적 장치를 보유하여야 합니다.

(b) 가입신청자는 반드시 신청자 본인의 명의로 가입 신청하여야 하며, 본인확인기관, SMS 발송 등을 통하여 실시하는 본인확인을 통과하여야 합니다.

(2) 회원이 회사가 제공하는 전자금융 서비스를 이용하기 위하여는 다음 각호의 요건을 추가로 충족하여야 합니다. 본 항의 요건을 충족하지 아니하는 회원은 회사가 제공하는 서비스의 전부 또는 일부를 이용할 수 없거나 이용에 제한을 받을 수 있습니다.

(a) 가입신청자 본인 명의의 실명확인이 된, 정상적 입출금이 가능한 금융기관의 계좌를 보유하여야 하며, 회사가 정하는 방법에 따른 본인 계좌 인증을 통과하여야 합니다. 향후 회사는 서비스 제공 및 본인 인증 등을 위하여 금융기관 계좌가 아닌 다른 정보나 인증수단을 요구할 수 있습니다.

제 5 조 (이용계약의 거절 등)

(1) 회사는 다음 각 호에 해당하는 가입신청에 대하여 승낙을 하지 않거나, 승낙 이후에도 이용의 제한 또는 이용계약의 해지 등의 조치를 취할 수 있습니다.

(a) 회사가 정한 서비스 제공 환경이 아니거나 기술상 서비스 제공이 불가능한 경우

(i) 특정 안드로이드 OS 환경 (5.0) 미만 단말기, 타 OS를 지원하는 기기, 혹은 하드웨어에서 개별적으로 정규 안드로이드 OS를 지원하지 않는 기기 에서는 회사에서 서비스 제공을 하지 않을 수 있습니다.

(ii) OS를 Rooting(루팅)한 기기는 보안상 이유로 서비스 지원을 하지 않습니다.

(b) 가입신청자가 신청시 제공한 정보에 허위, 누락, 또는 오류가 있는 경우

(c) 신청 명의가 가입신청자 본인의 명의가 아닌 경우

(d) 이미 가입된 회원이 중복하여 가입신청을 하는 경우

(e) 만 14세 이하의 자가 이용신청하는 경우

(f) 법인 명의로 가입하는 경우

(g) 부정한 용도 또는 영리를 추구할 목적으로 본 서비스를 이용하고자 하는 경우

(h) 기타 가입신청자의 귀책사유로 인하여 승낙이 불가능하거나 해당 가입신청이 법령, 본 약관 및 기타 회사가 정한 제반 사항에 배치되는 경우

(2) 제1항에 따른 신청에 있어 회사는 회원의 종류에 따라 전문기관을 통한 실명확인 및 본인인증을 요청할 수 있습니다.

(3) 회사가 제1항에 의해 이용계약을 거절하거나, 승낙 이후 이용의 제한 또는 이용계약의 해지 등의 조치를 취할 경우 회사는 이를 가입신청자에게 해당 전자적 장치를 통하여 그 사유를 알려야 합니다.

(4) 회사의 해제, 해지 및 이용제한에 대하여 회원은 회사가 정한 절차에 따라 이의신청을 할 수 있습니다. 이 때 이의가 정당하다고 회사가 인정하는 경우, 회사는 즉시

을 재개합니다.

제 6 조 (서비스의 이용개시, 이용시간 및 수수료)

(1) 제4조에 따라 회사가 가입신청인의 이용신청을 승낙함과 동시에 가입신청인은 회사가 제공하는 서비스의 회원이 되며, 이때부터 회사는 당해 회원에게 당해 약관이 정하는 서비스를 제공합니다.

(2) 회사는 본 약관이 정한 서비스 외에 추가적인 서비스를 제공하기 위해 회원에게 별도의 추가적인 약관 동의, 정보 수집 및 이용 동의 등 절차의 이행을 요청할 수 있으며, 이러한 절차가 완료되지 않는 경우 해당 회원이 추가적인 서비스의 전부 또는 일부를 이용하지 못할 수 있습니다. 회원이 추가 서비스를 이용할 경우, 각 서비스 별로 추가되는 이용약관과 본 약관의 내용이 상이한 경우 본 약관보다 추가적으로 적용되는 개별 약관이 우선 적용됩니다.

(3) 서비스의 이용은 회사의 업무상 또는 기술상의 특별한 지장이 없는 한 연중무휴, 1일 24시간을 원칙으로 합니다. 다만, 서비스 운영상의 필요성 (서버 및 클라이언트 유지, 보수, 점검, 교체, 고장, 정전 및 회사 서비스 폐업 등)으로 회사가 정한 기간 동안 본 서비스가 일시 중지될 수 있으며, 회사와 연계하여 서비스를 제공하는 기관, 업체 등의 사유로 서비스 중 일부 또는 전부가 중지될 수 있습니다. 서비스 중지가 발생하는 경우 그 내용을 홈페이지 또는 앰포 앱을 통하여 공지합니다.

(4) 회사는 회원에게 아래와 같은 서비스를 제공합니다.

(a) 자동 및 수동 모바일 핫스팟 탐지 및 연결 서비스

(b) 모바일 핫스팟 백그라운드 연결 유지 서비스

(c) 데이터-현금 환급 서비스

(d) 데이터 구매 서비스

(e) 기타 회사가 추가 개발하거나 다른 회사와의 제휴 계약 등을 통해 회원에게 제공하는 일체의 서비스

(5) 회사는 서비스를 일정범위로 분할하여 각 범위 별로 이용가능시간을 별도로 지정할 수 있습니다. 다만, 이러한 경우에는 그 내용을 사전에 공지합니다.

(6) 회사는 회원의 서비스 이용에 따른 수수료를 부과할 수 있으며, 수수료는 홈페이지 또는 앰포 앱을 통하여 고지합니다.

제 7 조 (서비스의 구성 및 변경)

(1) 회사가 제공하는 서비스는 다음 각 호의 서비스로 구성됩니다. 다만, 회원이 일정한 요건을 갖추었는지 여부에 따라 제공되는 서비스의 범위 및 이용 한도는 회원별로 다를 수 있습니다.

(a) 「전자금융거래법」에 따른 선불전자지급수단의 발행 및 관리

(b) 타 금융 연계 서비스의 제공

(c) 상기 각호에 부수하거나 연계된 업무

(2) 회사는 서비스의 개선을 위하여 수시로 서비스 내용의 전부 또는 일부를 변경할 수 있습니다. 이 경우 회사는 변경될 서비스의 내용 및 적용 일자를 제21조에 정한 방법에 따라 공지합니다.

(3) 회사는 다음 각 호에 해당하는 경우 서비스의 전부 또는 일부를 제한하거나 중지할 수 있습니다.

(a) 회사 또는 연계 금융기관 등의 설비 보수점검, 교체 및 고장, 통신의 두절 등의 사유가 발생한 경우

(b) 서비스 업그레이드 및 시스템 유지보수 등을 위해 필요한 경우

(c) 정전, 제반 설비의 장애 또는 이용량의 폭주 등으로 정상적인 서비스 이용에 지장이 있는 경우

(d) 가맹점과의 계약종료 등 회사의 제반 사정으로 서비스를 유지할 수 없는 경우

(e) 기타 천재지변, 국가비상사태 등 불가항력적 사유가 있는 경우

(4) 제3항에 의하여 본 서비스를 중단하게 되는 경우 회사는 제21조에서 정한 방법으로 회원에게 사전 공지합니다. 다만, 회사가 통제할 수 없는 사유로 본 서비스가 중단(회사 또는 앰포 서비스 운영자의 고의 및 과실이 없는 장애, 시스템 다운 등)되어 사전 공지가 불가능한 경우에는 그러하지 아니합니다.

제 8 조 (회원의 의무)

(1) 회원은 서비스를 이용함에 있어 다음 각 호의 행위를 하여서는 안됩니다.

(a) 본 약관 및 전자금융거래법 등 서비스 이용에 관련된 관계법령을 위반한 행위

(b) 서비스를 제공받기 위해 이용 신청 또는 변경 신청 시 허위 사실을 기재하거나 타인의 정보를 도용하는 등 정상적인 서비스 운영을 고의로 방해하는 일체의 행위

(c) 여하한 방법으로 회사가 정상적으로 제공하는 방법이 아닌 다른 방법으로 회사가 보유하고 있는 정보를 탈취, 저장, 공개 또는 부정한 목적으로 사용하는 행위

(d) 회사의 지식재산권, 제3자의 지식재산권 등 기타 권리를 침해하거나, 회사의 동의 없이 회원 또는 제3자의 상업적인 목적을 위하여 본 서비스 구성요소의 전부 또는 일부의 내용에 관하여 이를 복사, 복제, 판매, 재판매 또는 양수도하는 행위

(e) 기타 범죄 또는 법령이 금지하는 행위와 관련되었다고 의심받을 수 있는 일체의 행위

(f) 서비스와 관련된 설비의 오동작이나 정보 등의 파괴 및 혼란을 유발시키는 컴퓨터 바이러스 감염 자료를 등록 또는 유포하는 행위

(g) 기타 불법적이거나 부당한 행위

(2) 회원은 관련 법령, 본 약관의 규정, 이용안내 및 서비스 상에 공지한 주의사항, 회사가 통지하는 사항 등을 준수하여야 하며, 기타 회사의 업무에 방해되는 행위를 하여서는 아니 됩니다.

(3) 회원은 반드시 본인이 직접 서비스를 이용해야 하며, 전자적 장치를 타인에게 양도 또는 대여하는 등의 방법으로 타인으로 하여금 서비스를 이용할 수 있도록 하여서는 안됩니다. 이의 위반으로 인한 책임은 회원에게 있습니다.

제 9 조 (접근매체의 선정과 관리)

(1) 회사는 전자금융거래를 위하여 접근매체를 선정하여 사용 및 관리하고 회원의 신원, 권한 및 거래지시의 내용 등을 확인합니다.

(2) 회원은 접근매체를 사용함에 있어서 다른 법률에 특별한 규정이 없는 한 다음 각 호의 행위를 하여서는 안됩니다. 관련 법령이 허용하는 선불전자지급수단의 양도 또는 담보제공을 위하여 필요한 경우(제 c 호의 행위 및 이를 알선하는 행위는 제외)에는 그러하지 아니합니다.

(a) 접근매체를 양도하거나 양수하는 행위

(b) 대가를 수수ㆍ요구 또는 약속하면서 접근매체를 대여받거나 대여하는 행위 또는 보관ㆍ전달ㆍ유통하는 행위

(c) 범죄에 이용할 목적으로 또는 범죄에 이용될 것을 알면서 접근매체를 대여받거나 대여하는 행위 또는 보관ㆍ전달ㆍ유통하는 행위

(d) 접근매체를 질권 기타 담보의 목적으로 하는 행위

(e) 제 a 호부터 제 d 호까지의 행위를 알선하거나 광고하는 행위

제 10 조 (인증방법 및 부정거래탐지시스템)

(1) 서비스 이용을 위한 인증방법은 각 메뉴에 따라 SSID/비밀번호 인증, 휴대전화번호 인증 등 (이하 “비밀번호 등 본인인증수단”이라 합니다) 회사가 정한 방법이 이용됩니다.

(2) 회원은 서비스 이용을 위하여 이용신청 단계에서 회사가 정하는 바에 따라 비밀번호를 등록하여야 합니다. 등록된 비밀번호는 앰포 서비스 화면을 통하여 이를 변경할 수 있습니다.

(3) 회원은 비밀번호 등 본인인증수단을 철저히 관리하고, 타인에게 누설하여서는 안됩니다. 회원은 비밀번호 분실 시 앰포 서비스를 통해 회사가 정한 절차에 따라 재설정할 수 있습니다.

(4) 회사는 비밀번호 등 본인인증수단 외에 부정사용을 탐지하기 위한 별도의 부정거래탐지시스템(FDS)을 운영하고 있으며, 부정거래로 의심되는 거래가 탐지된 경우에는 해당 회원의 서비스 이용을 즉시 중단시키고 회사가 정한 추가 인증을 거치도록 할 수 있습니다.

제 11 조 (접근매체 분실 및 도난 관련 회원의 책임)

(1) 회원은 자신의 모바일 디바이스, 비밀번호 등 접근매체를 제3자에게 사용하게 하거나, 누설, 방치하여서는 안됩니다. 회원은 자신의 비밀번호를 주기적으로 변경하는 등 접근매체의 도용이나 위조 또는 변조를 방지하기 위하여 충분한 주의를 기울여야 합니다.

(2) 회원은 접근매체의 훼손, 분실, 도난 등의 사고가 발생하는 경우 즉시 그 사고 사실을 서면 또는 제16조 제5항에 따른 회사의 이메일로 회사에 통지하여야 합니다.

(3) 회사는 회원으로부터 전항에 따른 통지를 받은 때에는 그 때부터 제3자가 그 접근매체를 사용함으로 인하여 회원에게 발생한 손해를 배상할 책임이 있습니다. 단, 데이터 등 선불전자지급수단의 분실 또는 도난의 통지를 하기 전에 저장된 잔량에 대한 손해에 대하여 그 책임을 회원의 부담으로 할 수 있습니다.

제 12 조 (서비스 부정사용에 대한 책임)

(1) 회사는 다음 각 호의 어느 하나에 해당하는 사고로 인하여 회원에게 손해가 발생한 경우에는 그 손해를 배상할 책임을 부담합니다.

(a) 접근매체의 위조나 변조로 발생한 사고

(b) 계약체결 또는 거래지시의 전자적 전송이나 처리 과정에서 발생한 사고

(c) 전자금융거래를 위한 전자적 장치 또는 「정보통신망 이용촉진 및 정보보호 등에 관한 법률」 제2조 제1항 제1호에 따른 정보통신망에 침입하여 거짓이나 그 밖의 부정한 방법으로 획득한 접근매체의 이용으로 발생한 사고

(2) 전항에도 불구하고, 사고 발생에 있어서 회원의 고의나 중대한 과실이 있는 경우로서 다음 각 호에 해당하는 경우에는 그 손해의 전부 또는 일부를 회원이 부담할 수 있습니다.

(a) 회원이 접근매체를 제3자에게 대여하거나 그 사용을 위임한 경우 또는 양도나 담보의 목적으로 제공한 경우(전자금융거래법 제18조에 따라 선불전자지급수단이나 전자화폐를 양도하거나 담보로 제공한 경우를 제외)

(b) 제3자가 권한 없이 회원의 접근매체를 이용하여 전자금융거래를 할 수 있음을 알았거나 쉽게 알 수 있었음에도 불구하고 접근매체를 누설하거나 노출 또는 방치한 경우

(c) 회사가 접근매체를 통하여 회원의 신원, 권한 및 거래지시의 내용 등을 확인하는 것 외에 보안강화를 위하여 전자금융거래 시 요구하는 추가적인 보안조치를 회원이 정당한 사유 없이 거부하여 사고가 발생한 경우

(d) 회원이 제 c호에 따른 추가적인 보안조치에 사용되는 매체ㆍ수단 또는 정보에 대하여 다음 각 목의 어느 하나에 해당하는 행위를 하여 사고가 발생한 경우

(i) 누설ㆍ노출 또는 방치한 행위

(ii) 제3자에게 대여하거나 그 사용을 위임한 행위 또는 양도나 담보의 목적으로 제공한 행위

(3) 서비스 부정사용이 발생한 경우, 회원은 부정사용의 경위 및 피해 조사에 관하여 회사에 적극 협조하여야 합니다.

제 13 조 (서비스 이용제한)

(1) 회원의 서비스 이용 중 다음 각 호의 사유가 발생하는 경우, 회사는 해당 회원의 서비스 이용을 제한 또는 정지할 수 있습니다.

(a) 비밀번호를 누적하여 연속 5회 이상 오류 입력하는 경우

(b) 회원이 계속해서 6개월 이상 로그인하지 않은 경우

(c) 선불전자지급수단의 발행권면 최고한도 초과

(d) 접근매체의 도난 분실 등 사고 신고된 경우

(e) 회사가 제공하는 서비스 이용방법에 의하지 아니하고 비정상적인 방법으로 서비스를 이용하거나 회사의 시스템에 접근하는 행위

(f) 타인의 명의, 카드정보, 계좌정보 등을 도용하여 회사가 제공하는 서비스를 이용하는 행위

(g) 회원이 회사의 서비스 운영을 고의로 방해하는 경우

(h) 다른 회원의 정당한 이익을 침해하거나 법령에 위배되는 행위를 한 경우

(i) 본 약관에 위배되는 행위를 한 경우

(j) 회원이 악의적으로 마이너스(-) 데이터를 발생시킨 것으로 판단되는 경우

(k) 상품 거래를 가장하여 자금을 융통하는 등 비정상적인 거래를 시도하는 경우

(l) 이 약관에서 규정한 사항이나 별도 페이지에 규정한 이용정책을 위반한 경우

(m) 기타 회사가 합리적인 판단에 의해 서비스의 제공을 거부할 필요가 있다고 인정할 경우

(2) 제1항 제(e)호 내지 제(m)호에 따른 이용제한 시 서비스 이용을 통해 획득한 데이터 및 기타 혜택 등이 모두 소멸될 수 있으며, 회사는 이에 대해 별도로 보상하지 않습니다.

(3) 회원이 본 조의 금지행위를 하는 경우 서비스 이용을 제한함과 별도로 손해배상의 청구, 사법당국에 대한 고발 등 법적 조치를 취할 수 있습니다.

제 14 조 (지급의 효력 발생시기 및 철회)

(1) 전자지급수단을 이용하여 데이터를 지급하는 경우에는 그 지급의 효력은 다음 각 호의 어느 하나에서 정한 때에 발생합니다.

(a) 전자금융거래의 경우: 앰퍼-앰피 간 거래 지시된 데이터의 정보에 대하여 수취인의 원장에 데이터 입금기록이 끝난 때

(b) 전자적 장치로부터 환급을 요청하는 경우: 수취인이 현금을 수령한 때

(c) 선불전자지급수단으로 지급하는 경우: 거래 지시된 금액의 정보가 수취인이 지정한 전자적 장치에 도달한 때

(d) 그 밖의 전자지급수단으로 지급하는 경우: 거래 지시된 금액의 정보가 수취인의 계좌가 개설되어 있는 금융회사 또는 전자금융업자의 전자적 장치에 입력이 끝난 때

(2) 회원이 전자지급거래를 한 경우 그 전자지급거래의 종류에 따라 제1항에 정한 바에 따른 지급의 효력이 발생하기 전까지 본 약관 제16조 제5항에 기재된 연락처로 철회의 의사표시를 포함한 전자문서를 전송함으로써 거래지시를 철회할 수 있습니다.

제 15 조 (오류의 정정)

(1) 회원은 전자금융거래에 오류가 있음을 안 때에는 회사에 대한 정정을 요구할 수 있습니다. 회사는 오류의 정정요구를 받은 때 또는 스스로 전자금융거래에 오류가 있음을 안 때에는 이를 즉시 조사하여 시정한 후 정정요구를 받은 날 또는 오류를 발견한 날로부터 2주 이내에 오류의 원인과 처리 결과를 서면, 전화 또는 전자우편을 이용하여 해당 오류로 인하여 영향을 받은 회원에게 알립니다.

(2) 전항 후단의 통지를 회원이 전자문서가 아닌 서면으로 받고자 요청한 경우 회사는 모사전송, 우편, 전자우편 또는 직접 교부의 방법 등으로 통지합니다.

(3) 전항의 서면 요청에 관한 사항에는 제16조 제5항을 준용합니다.

제 16 조 (서비스 이용 내역의 보존 및 확인)

(1) 회사는 회원이 이용한 서비스의 내용을 추적, 검색하거나 그 내용에 오류가 발생한 경우에 이를 확인하거나 정정할 수 있는 기록을 생성하여 보존합니다.

(2) 서비스 이용 내역의 확인 대상 및 보존기간은 아래와 같습니다.

(a) 아래의 정보는 5년간 보관합니다.

(i) 거래의 데이터 및 잔량, 거래의 상대방에 관한 정보

(ii) 거래일시 및 전자적 장치의 종류 및 전자적 장치를 식별할 수 있는 정보

(iii) 거래가 계좌를 통하여 이루어지는 경우 거래 계좌의 명칭 또는 번호

(iv) 회사가 거래의 대가로 받은 수수료

(v) 해당 거래와 관련한 전자적 장치의 접속기록

(vi) 서비스의 신청 및 조건의 변경에 관한 사항

(vii) 건당 거래 데이터가 1GB를 초과하는 거래에 관한 기록

(b) 아래의 정보는 1년간 보관합니다.

(i) 전자지급수단의 이용과 관련된 거래승인에 관한 기록

(ii) 건당 거래 데이터가 1GB 이하인 거래에 관한 기록

(iii) 회원의 오류정정 요구사실 및 처리결과에 관한 사항

(3) 회사는 회원에게 서비스를 제공하면서 취득한 회원의 인적 사항, 회원의 계좌, 접근매체 및 서비스 이용 내역에 관한 정보를 법령에 의하거나 회원의 동의를 얻지 아니하고 제3자에게 제공하거나 서비스 제공 목적 외에 사용하지 아니합니다.

(4) 회사는 앰포 서비스의 조회 화면(‘리포트’ 또는 ‘마이페이지’)을 통하여 회원의 서비스 이용 내역을 확인하는 서비스를 제공할 수 있습니다. 회원이 요청하는 경우, 회사는 전자우편으로 이용 내역을 송부할 수 있습니다. 단, 회원이 서비스 이용 내역에 대해 전자문서가 아닌 서면 교부 요청을 하는 경우, 요청을 받은 날로부터 2주 이내에 모사전송, 우편의 방법 등으로 서비스 이용 내역에 관한 서면을 교부합니다.

(5) 서비스 이용 내역의 서면 제공 요청은 아래의 이메일 주소로 신청할 수 있습니다. 회원은 동 신청을 함에 있어서 서면을 수령하는데 필요한 정보를 명확히 제공하여야 합니다. 회사는 우편 제공시 일반 우편의 방법으로 송부합니다.

(a) 이메일: [dev@empoapp.com](mailto:dev@empoapp.com)

제 17 조 (개인정보의 보호 및 이용)

(1) 회사는 개인정보의 보호 및 처리와 관련하여 개인정보보호법, 정보통신망이용촉진및정보보호에관한법률 및 각 그 하위 법령에 정하는 사항을 준수하며, 개인정보의 보호를 위하여 노력합니다.

(2) 회사는 개인정보의 수집, 이용, 제공, 보호, 위탁 등에 관한 제반 사항의 구체적인 내용을 개인정보 처리방침을 통하여 규정하며, 개인정보 처리방침은 회사의 웹페이지, 앰포 앱 서비스 화면 등을 통하여 게시합니다.

제 18 조 (위치정보의 보호 및 이용)

(1) 회사는 서비스의 제공과 관련하여, 위치정보를 회원으로부터 수집하지 않습니다. 다만, 구글 안드로이드 운영체제(OS)에서 와이파이 기능을 활성화 하기 위하여 GPS 기능을 반드시 활성화합니다.

(2) 추후에 개선된 서비스 제공을 위하여 위치정보를 수집하게 될 경우에는 1개월 전 회원에게 이메일 혹은 문자메시지 서비스로 고지하며, 별도의 위치정보 수집에 관한 약관을 안내합니다.

제 19 조 (계약의 해지 등)

(1) 회원은 언제든지 회사에 이용계약 해지의 의사를 통지함으로써 이용계약을 해지할 수 있습니다. 단, 회원은 해지의사를 통지하기 전에 회사가 제공하는 서비스를 이용하여 진행 중인 데이터 거래 행위를 완결하여 더 이상 서비스를 통하여 처리되어야 할 금융 관계가 남지 않도록 하여야 하며, 이러한 조치를 취하지 아니하고 서비스의 이용 해지 의사표시를 함으로써 발생하는 불이익에 대하여는 회원이 그 책임을 부담하여야 합니다. 회사가 필요하다고 판단하는 경우, 해당 관계가 모두 해소될 때까지 해지의 효력 발생시기를 연기할 수 있습니다.

(2) 회원이 임의 해지, 재가입 등을 반복적으로 행함으로써 회사가 제공하는 혜택이나 경제적 이익을 비통상적인 방법으로 악용할 우려가 있다고 회사가 판단하는 경우, 회사는 재가입을 제한할 수 있습니다. 이러한 심사 목적 등을 위하여 회사는 회원 탈퇴 시 관계법령이 정한 기간동안 동안 해당 회원의 성명, 탈퇴일자, 탈퇴사유 등 필요한 정보를 보관할 수 있습니다.

(3) 이 약관에 따라 이용계약이 해지된 경우 회사는 회원에게 부가적으로 제공한 각종 혜택을 무효화 하거나 회수할 수 있습니다.
...
(4) 회사는 천재지변, 전쟁, 폭동, 소요, 기간통신사업자의 회선 이상, 기타 회사가 통제 불가능한 불가항력적 사유로 인하여 서비스를 제공할 수 없는 경우에는 회사의 고의 및 과실이 없는 한 이에 관하여 책임을 지지 않습니다.

(5) 회사는 회원의 고의 또는 과실로 인한 서비스 이용의 장애에 대하여는 책임을 지지 않습니다.

(6) 회사는 무료로 제공되는 서비스 이용과 관련하여 관련법에 특별한 규정이 없는 한 책임을 지지 않습니다.

제 21 조 (회원에 대한 공고 및 통지)

(1) 회사는 이 약관에 따라 제공되는 서비스의 운영과 관련한 공지사항을 회사의 홈페이지(https://empoapp.com) 또는 앰포 앱 서비스 화면에 게시, 회원이 제공한 이메일, 회원이 제공한 휴대전화번호로의 문자 메세지를 보내는 방법을 통하여 통지할 수 있습니다.

(2) 전항에 따른 통지는, 관련법령 또는 이 약관에서 특별히 전자문서가 아닌 서면 형태를 요구하는 경우가 아닌 한, 서면 통지로서 효력을 갖습니다.

제 22 조 (광고성 또는 맞춤형 정보의 제공)

(1) 회사는 본 서비스의 운영과 관련하여 광고성 정보를 제공하는 서비스를 운영할 수 있습니다.

(2) 회사는 광고성 정보 및 회원 맞춤형 정보를 문자 메시지나 푸시 메시지 형식으로 제공할 수 있으며, 이는 광고성 정보에 대한 사전 수신 동의가 있는 경우 등 법령상 허용된 경우에 한하여 제공됩니다.
...
(2) 회사가 앰포 앱을 통하여 제3자의 서비스를 이용할 수 있도록 하는 경우, 해당 서비스 제공의 주체는 그 제3자이며, 회사는 그 제3자가 제공하는 정보를 회원에게 전달되도록 하는 수단을 제공합니다. 제3자가 제공하는 서비스는 앰포 앱을 통하여 관련 약관 등에 대한 동의절차를 거친 회원에 한하여 이용할 수 있습니다.

(3) 회사는 서비스를 통하여 교환되는 회원과 제3자간의 정보와 관련하여 회원 또는 제3자의 거래의사의 전부 및 진정성, 타인의 권리에 대한 비침해성, 제3자와 회원이 제공하는 정보의 진실성 또는 적법성에 대하여 일체 보증하지 아니합니다.
...
제 26 조 (분쟁처리담당자 및 이의신청)

(1) 회원은 서비스 이용과 관련하여 회사에 이의가 있는 경우 서면으로 회사에 이의를 제기할 수 있습니다. 분쟁처리책임자는 아래와 같습니다.

(a) 분쟁처리책임자/담당자: 이재형

(b) 이메일: [dev@empoapp.com](mailto:dev@empoapp.com)

(2) 회원은 제1항에 따라 서면(전자문서를 포함합니다) 또는 전자적 장치를 이용하여 회사의 본점이나 영업점에 분쟁처리를 신청할 수 있으며, 회사는 15일 이내에 이에 대한 조사 또는 처리 결과를 회원에게 안내합니다.

(3) 회원은 회사의 분쟁처리결과에 대하여 이의가 있을 경우 ‘금융위원회의 설치 등에 관한 법률'에 따른 금융감독원의 금융분쟁조정위원회나 ‘소비자기본법'에 따른 한국소비자원의 소비자분쟁조정위원회에 회사의 전자금융거래서비스의 이용과 관련한 분쟁조정을 신청할 수 있습니다.

(4) 금융감독원의 분쟁조정결과 이용과정에서 회사에 책임이 있는 사실이 밝혀질 경우 회사는 이용대금의 전액을 부담합니다. 다만 회원 또는 회사가 금융감독원의 분쟁조정결과에 불복하여 관할법원에 민사소송을 제기하는 경우에는 그러하지 아니합니다.

제 27 조 (분쟁의 해결, 준거법 및 재판관할)

(1) 서비스 이용과 관련하여 회사와 회원 사이에 분쟁이 있는 경우 회사와 회원은 이를 해소하기 위하여 성실히 협의합니다.

(2) 전항에도 불구하고 회사와 회원의 분쟁이 해결되지 않는 경우, 해당 분쟁의 해결은 민사소송법에 따라 관할을 가지는 법원의 판결에 따르기로 하며, 대한민국법을 준거법으로 합니다.

제 2 장 데이터 서비스

제 28 조 (데이터의 충전)

(1) 회원이 데이터를 이용한 지급결제나 데이터 환급 서비스 등을 이용하기 위해서는 데이터를 서비스 이용 전 또는 서비스 이용과 동시에 충전하여야 합니다. 데이터의 충전은 회원이 등록한 신용카드 또는 다른 결제수단을 이용한 인-앱 결제 방법을 사용합니다.

(2) 데이터가 표상하는 가치는 1MB에 미화 0.01 달러 기준입니다.

(3) 회원이 데이터의 충전에 이용할 수 있는 수단은 회사가 사전에 결제 혹은 출금이체 (펌뱅킹) 관련 계약을 체결한 기관에 제한됩니다. 이용 가능한 기관의 목록은 회사의 홈페이지 또는 앰포 앱을 통해 공지합니다. 이용 가능한 기관에 변동사항이 생길 경우 회사는 즉시 홈페이지 또는 앰포 앱 공지사항을 통하여 회원에게 공지합니다.

(4) 회사는 상기에 정한 충전 방법이 아닌 다른 충전 방법을 제공할 수 있으며, 다른 충전 방법을 제공하는 경우, 그 충전 방법에 관하여는 본 약관 제21조에서 정한 방법으로 고객에게 알립니다.

제 29 조 (데이터의 이용)

(1) 회원은 제30조의 이용한도 범위 내에서 데이터 잔량의 전부 또는 일부를 제3자(다른 회원)에게 양도할 수 있습니다.

(2) 회원은 데이터의 양도 시 회사가 요구하는 상대방(다른 회원)의 정보를 정확히 입력하여야 하며, 해당 정보를 잘못 입력함으로 인한 문제에 대하여 회사는 책임을 지지 않습니다.

(3) 회원은 데이터의 양도 시 상대방(데이터를 양도받는 자)이 양도인의 성명을 확인할 수 있도록 할 수 있습니다.

(4) 회사가 제시하는 가맹점에서 해당 가맹점과의 계약에 따라 허용된 경우, 회원은 데이터를 해당 상품 또는 서비스 구매 등에 관한 지급 및 결제 수단으로 사용할 수 있습니다. 회사는 데이터를 사용하여 결제를 할 수 있는 가맹점의 정보에 관하여 본 약관 제21조에 정한 방법으로 회원에게 알립니다.

제 30 조 (데이터의 이용 한도 등)

(1) 회사는 선불전자지급수단의 발행권면에 관한 전자금융거래법령상의 한도를 넘을 우려가 있는 경우에는 당해 회원의 새로운 충전 요청을 제한하거나 거부할 수 있습니다.

(2) 회원의 각 명의당 발행권면, 충전, 데이터 양도 및 기타 이용 한도는 전자금융거래법 등 관련 법령에서 허용된 범위 내에서 회사가 정하는 바에 따르며, 회사가 정한 한도에 관한 사항은 본 약관 제21조에 정한 통지의 방법으로 회원에게 알립니다.

(3) 회사는 제2항의 한도를 정함에 있어, 회사가 요구하는 추가적인 인증 요건 등 회사가 제시하는 기준을 충족한 회원과 그렇지 않은 회원에 대하여 그 한도 적용을 달리 할 수 있습니다.

제 31 조 (데이터의 환급 등)

(1) 앰퍼/앰피 회원이 보유 중인 데이터의 환급을 회사에 요구할 경우, 회사는 그 보유중인 잔고 범위 내에서 회원이 요청하는 잔량에 이르기까지 회원이 입력한 은행계좌로의 현금을 계좌이체 하는 방법 또는 “전자적 장치”를 통한 현금 출금을 허용하는 방법으로 환급합니다. 재화 등의 구매나 이벤트 등을 통하여 회사로부터 무상으로 제공 받은 데이터는 동조의 환급 대상에서 제외됩니다. 환급의 경우 회사는 회사가 정하여 제21조에 따라 회원에게 고지하는 기준에 따른 환급 수수료를 공제할 수 있습니다.

(2) 다음 각 호의 어느 하나에 해당하는 경우, 회사는 회원의 환급 요청 시 앰포 앱에 기록된 데이터 잔량의 전부를 지급합니다.

(a) 천재지변 등의 사유로 가맹점이 재화 등을 제공하기 곤란하여 데이터를 사용하지 못하게 된 경우

(b) 데이터의 결함으로 가맹점이 재화 등을 제공하지 못하는 경우

(c) 앰포 앱에 기록된 데이터 잔량이 100분의 20 이하인 경우

(3) 회원의 환급 요청에도 환급이 보류되는 사유는 아래와 같습니다. 다만 회사는 그 사유가 해소되는 시점에 환급 처리를 합니다.

(a) 회원의 데이터 잔량이 회원의 환급 요청 금액보다 적은 경우

(b) 회원의 데이터 잔량이 환급 수수료보다 적을 경우

(4) 명의 도용 등 사고 신고가 접수되어, 회사의 합리적인 판단으로 누구에게 환급하여야 하는지 판단할 수 없는 경우 회사는 법령이 정한 절차에 따라 해당 금원을 공탁하는 등의 처리를 할 수 있습니다.

(5) 환급과 관련하여 제세공과금이 발생하는 경우, 해당 제세공과금은 회원이 부담합니다.

제 32 조 (데이터의 환급 및 소멸 조건)

(1) 회원은 다른 회원에게 모바일 핫스팟을 제공하는 방법으로 누적 획득한 데이터를 현금으로 환급 신청할 수 있습니다. 환급 조건 및 절차는 다음과 같습니다.

(a) 회원이 보유한 데이터가 10,000 MB 이상인 경우 환급 신청 가능합니다.

(b) 회원은 환급 신청 시 환급 받을 은행 계좌정보를 앰포 앱에서 입력합니다. 회사는 입력된 회원의 은행 계좌정보를 오로지 해당 송금절차에서만 사용하며, 환급 처리가 완료되면 관련법령(전자상거래 등에서 소비자 보호에 관한 법률의 대금결제 및 재화 등의 공급에 관한 기록과 전자금융거래법의 전자금융에 관한 기록)에 의거 5년동안 회원 거래내역에 해당 거래의 계좌번호가 입력되어 보관됩니다.

(2) 회원이 10,000 MB 이상의 데이터를 환급 신청하였을 경우, 실제 데이터 환급은 환급 신청일로부터 최대 7일이 소요됩니다. 단, 대한민국 혹은 현지 국가의 공휴일이 환급 신청 후 7일 내에 존재하는 경우에는 실제 환급까지 7일 이상이 소요될 수 있습니다.

(3) 회사는 회원의 데이터 환급 요청에 환급될 데이터에서 회사가 정하여 고지한 비율로 수수료를 차감한 후 해당 회원에게 환급합니다. 회사는 회원의 월별 데이터 공유 건수, 데이터 양 혹은 환급 요청 건수에 따라 임의로 수수료 인센티브를 차등 제공할 수 있습니다.

(4) 회원이 회사의 서비스로부터 이용 계약 해지를 신청하는 경우, 잔여 누적 데이터는 즉시 소멸됩니다.

제 33 조 (데이터의 청약철회 조건 및 절차)

(1) 회원의 청약철회는 결제 시 이용한 구글 플레이(Google Play) 인앱결제(Google In-App-Purchase) 서비스 정책을 따릅니다.

(a) 구글 플레이 환불 관련 안내:

[https://support.google.com/googleplay/answer/2479637?hl=ko](https://support.google.com/googleplay/answer/2479637?hl=ko)

(b) 구글 인앱결제 서비스에서 명시한대로 청약철회를 “개발자에게 문의”통해 진행 할 수 있습니다. 2항 이하의 조건이 충족된다면 회사에게 청약철회를 요청할 수 있습니다.

(2) 회원은 충전 완료 후 아직 사용하지 아니한 데이터에 대하여 데이터가 충전된 날로부터 7일 이내에는 회사의 웹페이지 혹은 앰포 앱에 마련된 데이터 환불 절차에 따라 청약 철회가 가능합니다.

(3) 본 조 제2항의 규정에 불구하고 다음 각 호의 어느 하나에 해당하는 경우, 회원은 회사의 의사에 반하여 제2항에 따른 청약 철회를 할 수 없습니다.

(a) 회원이 데이터를 일부 사용한 경우

(b) 그 밖에 거래의 안전을 위하여 법령으로 정한 경우

(4) 회원은 제2항 및 제3항에도 불구하고 다음 각 호의 어느 하나에 해당하는 경우, 그 데이터를 받은 날로부터 3개월 이내, 그 사실을 안 날 또는 알 수 있었던 날로부터 30일 이내에 청약 철회를 할 수 있습니다.

(a) 데이터가 표시∙광고의 내용과 다르거나 계약 내용과 다르게 이용된 경우

(b) 회사의 책임이 있는 사유로 인하여 서비스를 정상적으로 운영되지 않음을 인정하는 경우

(c) 회원이 이용할 수 있는 서비스가 전무하며 그에 대한 책임이 전적으로 회사에 있을 경우

(d) 그 밖에 거래의 안전을 위하여 법령으로 정한 경우

(5) 회원이 청약 철회를 요청한 경우 회사는 지체 없이 데이터를 삭제하고 삭제한 날부터 3 영업일 이내에 대금을 환급합니다.

제 34 조 (데이터의 환불 등)

(1) 회원은 데이터의 청약 철회가 불가능한 경우 혹은 소멸되지 않은 데이터가 남아있는 경우에는 잔량에 대한 환불을 요청할 수 있습니다. 그러나 다음 각 호의 어느 하나에 해당하는 경우, 환불을 받을 수 없습니다.

(a) 이미 해당 데이터를 사용한 경우

(b) 모바일 핫스팟을 제공하는 방법으로 누적 획득한 데이터로서 환급의 대상인 경우

(c) 각종 이벤트를 통해 회사가 무료로 제공한 데이터인 경우

(d) 외부 제휴사의 포인트로 충전한 데이터인 경우

(e) 회원이 타인의 명의를 도용하였거나 타인의 결제 정보를 도용하는 등 불법적인 방법으로 이용 계약을 체결하거나 대금을 결제한 사실이 인정되는 경우

(f) 그 밖에 거래의 안전을 위하여 법령으로 정한 경우

(2) 환불 시 10%의 환불 수수료를 공제하고 환불하며, 잔량이 1GB 미만인 경우에는 1,000원을 공제합니다. 100MB 미만 데이터는 환불이 불가합니다. 단, 회사의 귀책 사유가 있는 경우에는 전액을 환불합니다.

(3) 회사는 회원의 각종 법령의 위반 및 본 약관의 위반 등에 따라 회원의 이용 계약을 해지하거나 이용을 제한 하는 경우에는 환불을 거부할 수 있습니다.

제 35 조 (유효기간)

충전 혹은 적립한 날로부터 5년간 본 약관에 따라 이용되거나 환급되지 아니한 데이터는 소멸됩니다.

제 3 장 앰퍼 서비스

제 36 조 (앰퍼 서비스의 이용)

(1) 앰퍼 회원은 앰포 앱에서 앰피 회원에게 모바일 핫스팟을 제공할 수 있는 앰퍼 서비스를 이용할 수 있습니다.

(2) 회사는 앰포 앱을 통해 모바일 핫스팟 플랫폼 서비스를 제공하는 역할을 수행하며, 회원이 이용 계약 체결 시 앰퍼 서비스 이용 신청을 하고 회사가 이에 대해 승낙함으로써 회원은 앰퍼 서비스를 이용할 수 있는 앰퍼 회원으로서의 지위를 갖습니다.

(3) 회원의 모바일 디바이스, 앰포 앱 혹은 회사의 서버 등에서 계량하는 데이터 사용량 측정값은 물리적 기술 제한에 의해 최대 ±10% 데이터 단위 오차가 발생할 수 있습니다. ±10% 이내의 데이터 측정 오차로 인해 회사는 손실분을 보존하거나 이익분을 차감하지 않습니다.

제 4 장 앰피 서비스

제 37 조 (앰피 서비스의 이용)

(1) 앰피 회원은 앰포 앱에서 앰퍼 회원으로부터 모바일 핫스팟을 제공 받을 수 있는 앰피 서비스를 이용할 수 있습니다.

(2) 회사는 앰포 앱을 통해 모바일 핫스팟 플랫폼 서비스를 제공하는 역할을 수행하며, 회원이 이용 계약 체결 후 앰포 앱에서 데이터 구매를 신청하고 구매 금액을 지불함으로써 회원은 앰피 서비스를 이용할 수 있는 앰피 회원으로서의 지위를 갖습니다.

(3) 회원의 모바일 디바이스, 앰포 앱 혹은 회사의 서버 등에서 계량하는 데이터 사용량 측정값은 물리적 기술 제한에 의해 최대 ±10% 데이터 단위 오차가 발생할 수 있습니다. ±10% 이내의 데이터 측정 오차로 인해 회사는 손실분을 보존하거나 이익분을 차감하지 않습니다.

제 5 장 금융사기 등 피해 신고 계정에 대한 조치
...
(a) 자금을 송금·이체하도록 하는 행위

(b) 개인정보를 알아내어 자금을 송금·이체하는 행위
...
(1) 데이터의 양도 및 거래 서비스를 통하여 전기통신금융사기의 피해금을 송금한 회원은, 전기통신금융사기피해방지및피해금환급에관한특별법(이하 “특별법") 시행령 별지 제1호 서식에 따른 피해구제의 신청을 사기이용계좌를 관리하는 금융기관에게 제출할 수 있습니다. 이 경우 피해구제의 처리는 특별법과 해당 금융기관이 정하는 절차에 따라 처리됩니다.

(2) 제1항에도 불구하고, 특정 전기통신금융사기 사안에서 사기이용계좌를 관리하는 금융기관이 존재하지 아니하는 경우(피해자의 데이터 잔량이 가해자의 데이터 잔량으로 양도된 경우와 같이, 피해자나 가해자의 금융기관 계좌가 직접 이용되지 않은 경우) 피해자는 제1항의 피해구제의 신청을 회사에 제출할 수 있습니다. 이 때 피해자는 수사기관의 피해신고확인서 등 관련 자료를 함께 제출하여야 합니다.

제 40 조 (회사의 조치)

(1) 회사가 전조 제2항의 피해구제 신청서 및 수사기관의 피해신고 확인서를 제출 받는 경우, 회사는 가해자로 지목된 회원(“가해자")의 데이터 잔량의 인출을 일정 기간 제한할 수 있으며, 가해자의 데이터 잔량 전부를 가해자가 앰포 앱에 등록한 가해자 명의의 금융기관의 계좌(“가해자 금융계좌”)로 환급 처리함으로써 데이터 잔량을 강제 상환 처리할 수 있습니다.

(2) 회사가 제1항의 조치를 취함에 있어, 회사는 가해자 금융계좌를 관리하는 금융기관에 대하여 해당 계좌를 사기이용계좌로 신고할 수 있으며, 피해자는 이 과정에 필요한 협조와 조치를 취하여야 합니다.

(3) 회사는 제1항 및 제2항의 조치를 취하는데 필요한 정보의 수집 및 제3자 제공에 대한 동의 등 협조를 피해자에게 요구할 수 있으며, 피해자가 이에 협조하지 않는 경우 회사는 본조 따른 조치를 취하지 아니합니다. 피해자가 협조하지 아니하여 본조에 따른 조치를 취하지 못하게 되는 경우, 피해자는 본조에 따른 조치가 취해지지 아니함으로 입은 손해에 관하여 회사에 책임을 묻지 않습니다.

(4) 회사는 제1항 및 제2항의 조치를 취한 후, 피해자와 가해자에게 그 조치 사실을 통지합니다.

제 41 조 (피해 구제의 절차 등)

(1) 전조 제2항에 따라 가해자 금융계좌가 사기이용계좌로 지정된 이후의 피해자 권리 구제는 특별법과 해당 사기이용계좌를 관리하는 금융기관이 정하는 절차에 따릅니다.

(2) 전조 제1항에 따른 가해자 금융계좌로의 강제 상환이 완료된 날로 14일이 경과한 후, 수사기관이나 금융기관이 달리 요청하지 아니하는 한, 회사는 가해자의 앰포 계정에 취하였던 인출 제한 조치 등을 해제합니다.

제 42 조 (면책)

(1) 회원은 본 장에 따른 권리 구제 수단이 법에서 정한 절차가 아니며, 회사 단독으로는 특별법에 따른 권리 구제를 수행할 수 없으며, 특별법에서 정한 권리구제의 효과를 얻기 위해서는 금융기관, 수사기관 등의 협조가 필수적임을 이해합니다.

(2) 금융기관 또는 수사기관으로부터 필요한 협조를 얻을 수 없음으로 인하여, 본 장에서 회사가 취하기로 한 조치를 취하지 못하거나, 실질적 권리 보호 효과를 얻지 못하게 되는 경우, 회원은 그로 인한 손해에 관하여 회사에 책임을 묻지 않습니다.

- 부칙 -

이 약관은 2019년 7월 1일부터 시행됩니다.
      </pre>
    </div>
  </div>
</template>
